          ...
          <div class="card-content collapse show">
            <div class="card-body">
               ...
               <table id="recent-orders" class="table table-bordered mb-0">
                   <thead class="bg-info white">
                     <tr>
                         ...
                         <th class="border-top-0">Khoa id</th>
                         <th class="border-top-0">Action</th>
                     </tr>
                   </thead>
                   <tbody>
                     <tr v-for="lop in query.items.data" :key="lop.id">
                       ...
                       <td class="text-truncate">
                         <div class="btn-group mx-2" role="group">
                            ...
                            <span v-else-if="lop.deleteError" class="text-danger"> - ERROR: {{query.deleteError}}</span>
                            <button v-else type="button" class="btn btn-sm btn-icon btn-danger"><i class="la la-remove" @click.prevent="deleteLop(lop.id)"></i></button>
             ...
             <paginator v-if="query.items"
                ...
                :getDataWithEntries="getLopsWithEntries"
             ></paginator>
             <!-- ============================================ -->
             <!-- Loading -->
             <!-- ============================================ -->
