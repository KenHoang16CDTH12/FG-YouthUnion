<template>
  ...
  <section id="statistic">
          ...
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
                ...
                <div>
                  <i class="icon-layers teal font-large-2 float-right"></i>
                </div>
              </div>
              <div class="progress progress-sm mt-1 mb-0 box-shadow-2">
          ...
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
                ...
                <div>
                  <i class="icon-grid red font-large-2 float-right"></i>
                </div>
              </div>
              <div class="progress progress-sm mt-1 mb-0 box-shadow-2">
    ...
    <div class="row">
          ...
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
                ...
                <div>
                  <i class="icon-trophy cyan font-large-2 float-right"></i>
                </div>
              </div>
              <div class="progress progress-sm mt-1 mb-0 box-shadow-2">
                <div class="progress-bar bg-gradient-x-cyan" role="progressbar" style="width: 100%"
                aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
          </div>
          ...
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
                ...
                <div>
                  <i class="icon-fire pink font-large-2 float-right"></i>
                </div>
              </div>
              <div class="progress progress-sm mt-1 mb-0 box-shadow-2">
                <div class="progress-bar bg-gradient-x-pink" role="progressbar" style="width: 100%"
                aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
          </div>
      ...
      <!-- ============================================ -->
      <!-- END CARD FEDERATION ACTIVITIES-->
      <!-- ============================================ -->
    </div>
  </section>
</template>
