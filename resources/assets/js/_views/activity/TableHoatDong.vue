          ...
          <div class="card-content collapse show">
            ...
            <div class="card-body">
              ...
              <el-table v-if="objects" :data="objects" border fit highlight-current-row style="width: 100%" row-key="id">
                  ...
                  <el-table-column width="auto" align="center" label="Name">
                    <template slot-scope="scope">
                      <template v-if="scope.row.edit">
                        <el-input v-model="scope.row.name" class="edit-input" size="small" @keyup.enter.native="confirmEdit(scope.row)"/>
                  ...
                  <!-- form_date -->
                  <!-- ======================================== -->
                  <el-table-column width="auto" align="center" label="From date">
                    <template slot-scope="scope">
                  ...
                  <!-- end_date -->
                  <!-- ======================================== -->
                  <el-table-column width="auto" align="center" label="End date">
                    <template slot-scope="scope">
    ...
    methods: {
        ...
        handleDownload() {
          ...
          import('../../_vendors/Export2Excel').then(excel => {
            const tHeader = ['id', 'name', 'form_date', 'end_date'];
            const filterVal = ['id', 'name', 'form_date', 'end_date'];
            const data = this.formatJson(filterVal, this.objects);
            excel.export_json_to_excel({
              header: tHeader,
              data,
              filename: 'hoatdongs-list'
            })
